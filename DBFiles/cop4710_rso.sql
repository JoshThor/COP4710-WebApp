...
CREATE TABLE `rso` (
  ...
  `rsoName` varchar(45) DEFAULT NULL,
  `rsoStatus` varchar(10) DEFAULT 'Pending',
  PRIMARY KEY (`rid`),
  KEY `uid` (`uid`),
  KEY `unid` (`unid`),
  CONSTRAINT `rso_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `admin` (`uid`),
  CONSTRAINT `rso_ibfk_2` FOREIGN KEY (`unid`) REFERENCES `university` (`unid`)
...
INSERT INTO `rso` VALUES (1,1,1,'TestRSO','Pending'),(2,1,1,'TestRSO2','Pending');
...
-- Dump completed on 2017-04-06 18:33:00
